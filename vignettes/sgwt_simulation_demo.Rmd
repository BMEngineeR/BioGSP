...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE, 
                      fig.width = 5, fig.height = 3.5, dpi = 36,
...
```{r visualize-pattern, fig.width=7, fig.height=3}
...
```{r fourier-modes, fig.width=7, fig.height=5}
...
```{r plot-decomposition, fig.width=7, fig.height=5}
...
```{r similarity-visualization, fig.width=7, fig.height=6}
